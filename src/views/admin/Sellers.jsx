        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    <img className='w-[45px] h-[45px]' src={`http://localhost:5173//images/category/${d}.jpeg`} alt="" />
                </td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Hon Tone </td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Lazy Shop</td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    <span>Pending</span> </td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>oop@gmail.com </td>
